...
module __SMALL_HINGE__outer_hinge_block(
  main_thickness,
  h,
  gear_offset,
  flip_helix,
  ...
  difference() {
    ...
    union() {
      translate(
        [
          0,
          __SMALL_HINGE__GEAR_VERTICAL_BACK_GUTTER - _EPSILON,
    ...
    rotate_extra_degrees(main_thickness=main_thickness, extra_degrees=extra_degrees) translate(
        [
          main_thickness / 2,
          -main_thickness / 2 + (shave_end_tangents ? __SMALL_HINGE__END_TANGENT_SHAVE : 0),
          block_h / 2,
        ],
...
module __SMALL_HINGE__outer_hinge_gears(
  main_thickness,
  h,
  gear_offset,
  flip_helix,
      ...
      difference() {
        translate(
          ...
          rotate([0, 0, gear_offset])
            linear_extrude(
              gear_h - __SMALL_HINGE__GEAR_VERTICAL_CLEARANCE * main_clearance_scale,
              twist=90 * gear_h / main_thickness * (flip_helix ? -1 : 1)
            ) offset(-0.05)
        ...
        rotate_extra_degrees(main_thickness=main_thickness, extra_degrees=extra_degrees - 90) translate(
            [
              main_thickness * 1.5 - ( (shave_end_tangents ? __SMALL_HINGE__END_TANGENT_SHAVE : 0) ),
              main_thickness,
              gear_h / 2,
            ],
...
module __SMALL_HINGE__plug(main_thickness) {
  translate([0, 0, -__SMALL_HINGE__PLUG_LENGTH + __SMALL_HINGE__PLUG_FRUSTRUM_LENGTH])
    cylinder(
      h=__SMALL_HINGE__PLUG_LENGTH - __SMALL_HINGE__PLUG_FRUSTRUM_LENGTH + __SMALL_HINGE__PLUG_VERTICAL_CLEARANCE + _EPSILON,
      r=main_thickness * __SMALL_HINGE__PLUG_RADIUS_FRACTION
    );
  translate([0, 0, -__SMALL_HINGE__PLUG_LENGTH])
    cylinder(
      h=__SMALL_HINGE__PLUG_FRUSTRUM_LENGTH, r1=__SMALL_HINGE__PLUG_FRUSTRUM_END_RADIUS,
...
module __SMALL_HINGE__port_negative(main_thickness, plug_clearance_scale) {
  translate([0, 0, -__SMALL_HINGE__PLUG_LENGTH + __SMALL_HINGE__PLUG_FRUSTRUM_LENGTH])
    cylinder(
      h=__SMALL_HINGE__PLUG_LENGTH - __SMALL_HINGE__PLUG_FRUSTRUM_LENGTH + __SMALL_HINGE__PLUG_VERTICAL_CLEARANCE + _EPSILON,
      r=main_thickness * __SMALL_HINGE__PLUG_RADIUS_FRACTION + __SMALL_HINGE__DEFAULT_PLUG_CLEARANCE * plug_clearance_scale
    );
  translate([0, 0, -__SMALL_HINGE__PLUG_LENGTH]) cylinder(
      ...
      r2=main_thickness * __SMALL_HINGE__PLUG_RADIUS_FRACTION + __SMALL_HINGE__DEFAULT_PLUG_CLEARANCE * plug_clearance_scale
    );
}
...
module __SMALL_HINGE__bottom(
  main_thickness,
  gear_offset,
  rotate_angle_each_side,
  plug_clearance_scale,
  round_far_side,
  main_clearance_scale,
  extra_degrees,
  shave_end_tangents,
  ...
  mirror([1, 0, 0]) difference() {
      ...
      union() {
        gear_h = 10 - __SMALL_HINGE__GEAR_OFFSET_HEIGHT;
        difference() {
          __SMALL_HINGE__rotate_angle(
            main_thickness, rotate_angle_each_side,
          ...
          translate([0, 0, 10]) mirror([0, 0, 1]) translate([-_EPSILON, -_EPSILON, -_EPSILON]) cube(
                  [
                    _EPSILON + __SMALL_HINGE__HINGE_SHAVE * main_clearance_scale,
                    main_thickness + 2 * _EPSILON,
                    __SMALL_HINGE__GEAR_OFFSET_HEIGHT + _EPSILON,
                  ],
                );
          translate([0, 0, 10]) mirror([0, 0, 1]) //
...
module __SMALL_HINGE__half(
  ...
  difference() {
    union() {
      __SMALL_HINGE__bottom(
        main_thickness, gear_offset, rotate_angle_each_side, plug_clearance_scale,
  ...
  translate([main_thickness / 2, main_thickness / 2, 10 + __SMALL_HINGE__PLUG_VERTICAL_CLEARANCE])
    cylinder(
      h=10 - 2 * __SMALL_HINGE__PLUG_VERTICAL_CLEARANCE,
  ...
  translate(
    [
      -_EPSILON,
      main_thickness / 2 - main_thickness / 2 + __SMALL_HINGE__CONNECTOR_OUTSIDE_CLEARANCE,
      10 + __SMALL_HINGE__PLUG_VERTICAL_CLEARANCE,
    ],
  )
    cube(
      [
        main_thickness / 2,
        main_thickness / 2 * 2 - __SMALL_HINGE__CONNECTOR_OUTSIDE_CLEARANCE * 2,
...
module small_hinge_30mm(
  ...
  common_gear_offset = 0,
  extra_degrees = 0,
  shave_end_tangents = false,
  extend_block_ends = 0
) {
  mirror([1, 0, 0])
    __SMALL_HINGE__half(
      main_thickness, common_gear_offset, rotate_angle_each_side=rotate_angle_each_side,
  ...
  __SMALL_HINGE__half(
    main_thickness, 360 / 8 / 2 + common_gear_offset,
